...
<style>
  ...
  *{box-sizing:border-box}
  ...
  .hero{
    display:flex; gap:20px; align-items:center; padding-bottom:12px; border-bottom:1px dashed rgba(255,255,255,.12); margin-bottom:18px;
  }
  .badge{
  ...
  .user{
    display:flex; gap:16px; align-items:center; margin:12px 0 6px;
  }
  .avatar{
    width:56px; height:56px; border-radius:50%; object-fit:cover; flex:0 0 auto;
    border:2px solid rgba(255,255,255,.12); box-shadow:0 8px 20px rgba(0,0,0,.25)
  }
  .kv{display:grid; gap:8px; margin:12px 0 6px}
  .row{display:flex; gap:8px; align-items:baseline}
  .key{width:110px; color:var(--muted)}
  .val{font-weight:600; color:var(--text); word-break:break-all}
  ...
  pre{
    margin:0; padding:16px; border-radius:12px; background:rgba(2,6,23,.55);
    border:1px solid rgba(255,255,255,.08); overflow:auto; color:#e5edff;
  }
